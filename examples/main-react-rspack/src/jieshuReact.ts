...
import JieshuReactRuntime, { type JieshuReactProps, type JieshuReactStatics } from 'jieshu-react';

// jieshu-react is developed against React 17 in this workspace. Its runtime is
