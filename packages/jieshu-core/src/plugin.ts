import type { ScriptObjectLoader, JieshuPlugin } from './contracts';
...
type PluginCodeLoader = NonNullable<JieshuPlugin['cssLoader']>;
...
export function getEffectLoaders(loaderType: EffectLoaderType, plugins: readonly JieshuPlugin[]): UrlMatcher[] {
...
const defaultPlugin: JieshuPlugin = {
...
export function getPlugins(plugins: readonly JieshuPlugin[] | undefined): JieshuPlugin[] {
