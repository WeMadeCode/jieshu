...
export type JieshuProps = object;

/** 子应用通过 `$jieshu.props` 读取时的安全默认视图。 */
export type InjectedJieshuProps = Record<string, unknown>;
...
/** @deprecated 请使用 JieshuPlugin。 */
export type plugin = JieshuPlugin;
