...
/**
 * Keeps lifecycle state transitions in one place. Public Jieshu flags remain the
...
/**
 * Serial script scheduler backed by Jieshu's public execQueue. Injected scripts
