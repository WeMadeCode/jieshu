...
interface IntentRuntimeWindow {
  ...
  __WUJIE_CORE_INTENTS?: OperationSlots;
  __WUJIE_INJECT?: { coreOperationSlots?: OperationSlots };
  __WUJIE?: { inject?: { coreOperationSlots?: OperationSlots } };
}
...
function sharedSlots(): OperationSlots {
  ...
  const slots =
    runtimeWindow.__WUJIE_INJECT?.coreOperationSlots ??
    (runtimeWindow.__POWERED_BY_WUJIE__ ? runtimeWindow.__WUJIE?.inject?.coreOperationSlots : undefined) ??
    runtimeWindow.__WUJIE_CORE_INTENTS ??
    (Object.create(null) as OperationSlots);
  runtimeWindow.__WUJIE_CORE_INTENTS = slots;
  runtimeWindow.__WUJIE_INJECT = { ...runtimeWindow.__WUJIE_INJECT, coreOperationSlots: slots };
  return slots;
}
